# L‑Bracket Component (Autodesk Inventor Practice Project)
...
* `L-Bracket.ipt` — Main Inventor part file
* `README.md` — This documentation
* `bracket.png` — Screenshot of the final part

## 🚀 How to Use

1. Open the `.ipt` file using Autodesk Inventor.
2. Inspect or modify the model.
3. Use features such as **Measure**, **Section View**, or **Edit Sketch** to explore the design.
